$(function(){
	...
	$(".web05").wrapInner(`<a href="https://roland.gnjoy.com.tw/ACT_20180704_RO_Comics/Index" target=_blank></a>`);
	...
	$(".web012").wrapInner(`<a href="https://tro.gnjoy.com.tw/Event/ACT_20190604_Wish/" target=_blank></a>`);
	$(".web013").wrapInner(`<a href="https://tro.gnjoy.com.tw/Event/ACT_20190626_NewServe" target=_blank></a>`);
	$(".web014").wrapInner(`<a href="https://tro.gnjoy.com.tw/event/ACT_20210104_NewServer" target=_blank></a>`);
	$(".web015").wrapInner(`<a href="rpq/" class="ps" target=_blank></a>`);
